...
extension ViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let waterData: WaterDate = mainPlant?.waterDates?[indexPath.row] as! WaterDate
        let date = waterData.data!
...
//            let coreDataStack = CoreDataStack(modelName: "WaterLog")
//
//            mainPlant?.waterDates.remove(at: indexPath.row)
